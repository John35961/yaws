...
from app.weather.functions import call_apis, store_data_from
...
def home():
    ...
    if request.method == "POST":
        ...
        nominatim_api = get(
            ...
            f"{corrected_user_query_location}?format=json"
        ).json()
        ...
        apis_data = store_data_from(
            apis_responses["opwm_cel_api"],
    ...
    return render_template("home.html", city_form=city_form)
